...
import com.example.nxt.mydatetimepicker.views.LoopListener;
import com.example.nxt.mydatetimepicker.views.LoopView;
...
public class DatePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    private void initPickerViews() {
        ...
        for(int l=0;l<60;l++){
            minuteList.add(format2LenStr(l));
        }
    ...
    private void initDayPickerView() {
        ...
        //Why do I judge?Because of there is a bug that occur 2015-2-31
        if(monthPos==1&&dayMaxInMonth==31){
            for (int i = 0; i < 28; i++) {
